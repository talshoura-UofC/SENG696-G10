...
def specialConfirmation(name,em_id,pat_id):
    SDPage.destroy()
    def specialInvoice(recievedValue):
        ...
        #cost=int(a[1])
        email_id='-u '+em_id
        patientid='-t '+str(pat_id)
        appoint='-o '+str(recievedValue)
        #print(email_id,patientid)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 4', email_id, appoint, patientid], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        if proc.poll() == 1:
            messagebox.showinfo("Congrats","Appointment Confirmed")
            welcome(em_id,pat_id)
            SCPage.destroy()
        if proc.poll() == 2:
            messagebox.showinfo("Error","Appointment Not Confirmed", "Please do it again")
            welcome(em_id,pat_id)
            SCPage.destroy()
        #def grab_date():
            #date=cal.get_date()
    ...
    second_frame = Frame(my_canvas)
    my_canvas.create_window((0,0), window=second_frame, anchor="nw")
    background=Canvas(second_frame,width=600,height=1500)
    image=ImageTk.PhotoImage(Image.open("Confirmation Page.jpg"))
    label1=Label(image=image)
    label1.image=image
    background.create_image(0,0,anchor='nw',image=image)
    ...
    var=tk.StringVar()
    if name=="Diya More":
        dm=Label(second_frame,text='30 mins-C$200/session',font=('Bahnschrift Condensed',16))#,variable=var,value='Diya More, C$200',command=selected,tristatevalue=0,bg="black",fg="gold")
        dm.place(x=315,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 5'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
        for i in output:
           ot.append(Radiobutton(second_frame,text=i["APPOINTMENT_DATE"]+'-'+i["APPOINTMENT_TIME"],font=('Bahnschrift Condensed',16),variable=var,value='1 '+i['APPOINTMENT_DATE']+i['APPOINTMENT_TIME'],command=partial(selected,i['SN']),tristatevalue=0,bg="black",fg="gold") )
        for i in ot:
           i.place(x=25,y=pl)
           pl+=30
    elif name=="Tarun Matthew":
        tm=Label(second_frame,text='30 mins-C$200/session',font=('Bahnschrift Condensed',16))#,variable=var,value='Tarun Matthew, C$200',command=selected,tristatevalue=0,bg="black",fg="gold")
        tm.place(x=315,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 6'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
        ...
        kl=Label(second_frame,text='30 mins-C$200/session',font=('Bahnschrift Condensed',16))#,variable=var,value='Karim Lok, C$200',command=selected,tristatevalue=0,bg="black",fg="gold")
        kl.place(x=315,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 7'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
        ...
        for i in ot:
           i.place(x=25,y=pl)
           pl+=30
    elif name=="Vijay Ganeshan":
        vg=Label(second_frame,text='30 mins-C$200/session',font=('Bahnschrift Condensed',16))#,variable=var,value='Vijay Ganeshan, C$200',command=selected,tristatevalue=0,bg="black",fg="gold")
        vg.place(x=315,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 8'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
        ...
        for i in ot:
           i.place(x=25,y=pl)
           pl+=30
    elif name=="Ananya Bahri":
        ab=Label(second_frame,text='30 mins-C$200/session',font=('Bahnschrift Condensed',16))#,variable=var,value='Ananya Bahri, C$200',command=selected,tristatevalue=0,bg="black",fg="gold")
        ab.place(x=315,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 9'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
        ...
        for i in ot:
           i.place(x=25,y=pl)
           pl+=30
    elif name=="Radhika Ramanathan":
        rr=Label(second_frame,text='30 mins-C$200/session',font=('Bahnschrift Condensed',16))#,variable=var,value='Radhika Ramanathan, C$200',command=selected,tristatevalue=0,bg="black",fg="gold")
        rr.place(x=313,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 10'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
    ...
    backButtonLabel=Label(image=back)
    backButtonLabel.image=back
    backButton=Button(second_frame,image=back,borderwidth=0,highlightthickness=0,command=partial(specialdoctors2,em_id,pat_id))
    backButton.place(x=450,y=20)

#Special Doctors Page
def specialdoctors2(em_id,pat_id):
    SCPage.destroy()
    global SDPage
    ...
    backButtonLabel=Label(image=back)
    backButtonLabel.image=back
    backButton=Button(second_frame,image=back,borderwidth=0,highlightthickness=0,command=partial(servicess,em_id,pat_id))
    backButton.place(x=450,y=20)
    user=ImageTk.PhotoImage(Image.open("User Logo.jpg"))
    userButtonLabel=Label(image=user)
    userButtonLabel.image=user
    ...
    diyaMoreButton=Button(second_frame,image=diyaMore,command=partial(specialConfirmation,"Diya More",em_id,pat_id),borderwidth=0,highlightthickness=0)
    ...
    tarunMatthewButton=Button(second_frame,image=tarunMatthew,command=partial(specialConfirmation,"Tarun Matthew",em_id,pat_id),borderwidth=0,highlightthickness=0)
    ...
    karimLokButton=Button(second_frame,image=karimLok,command=partial(specialConfirmation,"Karim Lok",em_id,pat_id),borderwidth=0,highlightthickness=0)
    ...
    vijayGaneshanButton=Button(second_frame,image=vijayGaneshan,command=partial(specialConfirmation,"Vijay Ganeshan",em_id,pat_id),borderwidth=0,highlightthickness=0)
    ...
    ananyaBahriButton=Button(second_frame,image=ananyaBahri,command=partial(specialConfirmation,"Ananya Bahri",em_id,pat_id),borderwidth=0,highlightthickness=0)
    ...
    radhikaRamanathanButton=Button(second_frame,image=radhikaRamanathan,command=partial(specialConfirmation,"Radhika Ramanathan",em_id,pat_id),borderwidth=0,highlightthickness=0)
...
#Special Doctors Page
def specialdoctors(em_id,pat_id):
    SPage.destroy()
    global SDPage
    SDPage=Toplevel(MPage)
    main_frame=Frame(SDPage)
...
def servicess(em_id,pat_id):
    ...
    generalDoctorsButton=Button(SPage,image=generalDoctors,command=partial(generaldoctors,em_id,pat_id),borderwidth=0,highlightthickness=0)
    ...
    specialDoctorsButton=Button(SPage,image=specialDoctors,command=partial(specialdoctors,em_id,pat_id),borderwidth=0,highlightthickness=0)
...
def generalDoctorsConfirmation(name,em_id,pat_id):
    GDPage.destroy()
    ...
    background.create_image(0,0,anchor='nw',image=image)
    background.pack(expand=True,fill=BOTH)
    GDCPage.geometry('600x1000')
    #cal=Calendar(GDCPage,selectmode="day",year=2022,month=8,day=22)
    #cal.place(x=25,y=310)
    var=tk.StringVar()
    if name == "Usha Manda":
        um=Label(second_frame,text='30 mins-C$150/session',font=('Bahnschrift Condensed',16))#variable=var,value='Usha Manda, C$150',command=selected,tristatevalue=0,bg="black",fg="gold")
        ...
        for i in ot:
           i.place(x=25,y=pl)
           pl+=30
    if name== "John Varghese":
        jv=Label(second_frame,text='30 mins-C$150/session',font=('Bahnschrift Condensed',16))#variable=var,value='John Varghese, C$150',command=selected,tristatevalue=0,bg="black",fg="gold")
        jv.place(x=315,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 2'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
        ...
        for i in ot:
           i.place(x=25,y=pl)
           pl+=30
    if name== "Jasmine Raju":
        jr=Label(second_frame,text='30 mins-C$150/session',font=('Bahnschrift Condensed',16))#variable=var,value='Jasmine Raju, C$150',command=selected,tristatevalue=0,bg="black",fg="gold")
        jr.place(x=315,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 3'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
        ...
        for i in ot:
           i.place(x=25,y=pl)
           pl+=30
    if name== "Anand Radhakrishnan":
        ar=Label(second_frame,text='30 mins-C$150/session',font=('Bahnschrift Condensed',16))#variable=var,value='Anand R, C$150',command=selected,tristatevalue=0,bg="black",fg="gold")
        ar.place(x=315,y=280)
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 3', '-d 4'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        output = json.loads(out[0].decode("utf-8"))
        pl=280
        ot=[]
    ...
    backButtonLabel=Label(image=back)
    backButtonLabel.image=back
    backButton=Button(second_frame,image=back,borderwidth=0,highlightthickness=0,command=partial(generaldoctors2,em_id,pat_id))
    backButton.place(x=450,y=20)
        
#General Doctors Page
def generaldoctors(em_id,pat_id):
    SPage.destroy()
    global GDPage
    ...
    backButtonLabel=Label(image=back)
    backButtonLabel.image=back
    backButton=Button(second_frame,image=back,borderwidth=0,highlightthickness=0,command=partial(servicesg,em_id,pat_id))
    backButton.place(x=450,y=20)
    user=ImageTk.PhotoImage(Image.open("User Logo.jpg"))
    userButtonLabel=Label(image=user)
    userButtonLabel.image=user
    ...
    johnVargheseButton=Button(second_frame,image=johnVarghese,borderwidth=0,highlightthickness=0,command=partial(generalDoctorsConfirmation,"John Varghese",em_id,pat_id))
    ...
    ushaMandaButton=Button(second_frame,image=ushaManda,borderwidth=0,highlightthickness=0,command=partial(generalDoctorsConfirmation,"Usha Manda",em_id,pat_id))
    ...
    jasminRajuButton=Button(second_frame,image=jasminRaju,borderwidth=0,highlightthickness=0,command=partial(generalDoctorsConfirmation,"Jasmine Raju",em_id,pat_id))
    ...
    anandRadhakishanButton=Button(second_frame,image=anandRadhakishan,borderwidth=0,highlightthickness=0,command=partial(generalDoctorsConfirmation,"Anand Radhakrishnan",em_id,pat_id))
...
#General Doctors Page
def generaldoctors2(em_id,pat_id):
    GDCPage.destroy()
    global GDPage
    GDPage=Toplevel(MPage)
    main_frame=Frame(GDPage)
...
def welcome(em_id,pat_id):
    ...
    userButton.place(x=550,y=8)
    continueButton=Button(WPage, text="CONTINUE",font=('Bahnschrift Condensed',24),bg='black',fg='gold',borderwidth=0,command=partial(services,em_id,pat_id))
...
def register():
    ...
    def enter():
        ...
        usid=0
        psid=0
        if firstname.get()=="" or lastname.get()=="" or email.get()=="" or address.get()=="" or password.get()=="":
            messagebox.showerror("Error","All Fields are Required")
        em_id=email.get()   
        first_name='-f '+firstname.get()
        last_name='-l '+lastname.get()
        email_id='-u '+email.get()
        add_ress='-a '+address.get()
        pass_word='-p '+password.get()
        phone_no='-m '+phone.get()
        
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 2', email_id, pass_word, first_name, last_name, add_ress, phone_no], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        #output = json.loads(out[0].decode("utf-8"))
        if(proc.poll()==2):
            messagebox.showinfo('Error','User credentials Already in Use, Please Login')
            login()
            RPage.destroy()
    ...
    background=Canvas(RPage,width=600,height=650)
    image=ImageTk.PhotoImage(Image.open("Registration Page.jpg"))
    label1=Label(image=image)
    label1.image=image
    background.create_image(0,0,anchor='nw',image=image)
    background.pack(expand=True,fill=BOTH)
    RPage.geometry('600x650')
    def mainpage():
        RPage.destroy()
        MPage.deiconify()
    def item_selected(event):
    ...
    def button_hover7(a):
        ...
        options= ('T & C', 'CLOSE')
        options_var = tk.StringVar(value=options)
        userOptions= tk.Listbox(RPage,listvariable=options_var,height=1,selectmode='browse',relief='solid')
        userOptions.place(x=450,y=50)
        userOptions.bind('<<ListboxSelect>>',item_selected)
    def button_hover_leave7(b):
        def button_hover8(a):
    ...
    back=ImageTk.PhotoImage(Image.open("Back-Button-Logo.jpg"))
    backButtonLabel=Label(image=back)
    backButton=Button(RPage,image=back,borderwidth=0,highlightthickness=0,command=mainpage)
    backButton.place(x=450,y=20)
    backButtonLabel.image=back
    user=ImageTk.PhotoImage(Image.open("User Logo.jpg"))
    userButtonLabel=Label(image=user)
    ...
    address=Entry(RPage,font=large_font,bg="black",fg="white",width=24,insertbackground="white")
    address.place(x=250,y=370)
    address.bind("<Return>",enter)
    password=Entry(RPage,font=large_font,bg="black",fg="white",width=24,insertbackground="white")
    password.place(x=250,y=439)
    password.bind("<Return>",enter)
    phone=Entry(RPage,font=large_font,bg="black",fg="white",width=24,insertbackground="white")
    phone.place(x=250, y=511)
    phone.bind("<Return>",enter)
    submit=ImageTk.PhotoImage(Image.open("Submit Button.jpg"))
    submitButtonLabel=Label(image=submit)
    submitButtonLabel.image=submit
    submitButton=Button(RPage,image=submit,borderwidth=0,highlightthickness=0,command=enter)
    submitButton.place(x=235,y=583)
    userButton.bind("<Enter>",button_hover7)
    userButton.bind("<Leave>",button_hover_leave7)
...
def login():
    ...
    def entry():
        ...
        proc = subprocess.Popen(['python3', 'UI_Agent.py',  '-c 1', email_id, pass_word], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
        out = proc.communicate()
        
        if proc.poll() == 1:
            messagebox.showinfo("Congrats","Login Successfull")
            output = json.loads(out[0].decode("utf-8"))
            pat_id=output['SN']
            welcome(em_id,pat_id)
            LPage.destroy()
        elif proc.poll() == 2:
            messagebox.showinfo("User not found", "User not found, Please register")
            register()
            LPage.destroy()
    ...
    back=ImageTk.PhotoImage(Image.open("Back-Button-Logo.jpg"))
    backButtonLabel=Label(image=back)
    backButton=Button(LPage,image=back,borderwidth=0,highlightthickness=0,command=mainpage)
    backButton.place(x=450,y=20)
    backButtonLabel.image=back
    user=ImageTk.PhotoImage(Image.open("User Logo.jpg"))
    userButtonLabel=Label(image=user)
    ...
    userButton.place(x=550,y=8)
    email=Entry(LPage,font=large_font,bg="black",fg="white",width=24,insertbackground="white")
    email.place(x=250,y=233)
    email.bind("<Return>",entry)
